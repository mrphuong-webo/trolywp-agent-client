...
Xem **[docs/QUY-TRINH-TICH-HOP.md](docs/QUY-TRINH-TICH-HOP.md)** để có hướng dẫn end-to-end: 4 thành phần (webo-mcp / WEBO MCP, webo-hmac-auth, trolywp-agent-client, n8n-nodes-webo-mcp), cấu hình workflow n8n, lịch sử chat, deploy node, xử lý lỗi.
