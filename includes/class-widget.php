...
class TrolyWP_Agent_Client_Widget extends WP_Widget {
    ...
    public function widget($args, $instance) {
        ...
        if (empty($webhook_url)) {
            ...
            echo '<div id="trolywp-chat-sidebar" style="display:none;position:fixed;top:0;right:0;width:350px;height:100vh;background:#fff;border-radius:12px 0 0 12px;box-shadow:-2px 0 16px rgba(0,0,0,0.2);z-index:9999;overflow:hidden;transition:right 0.3s;">
                <div style="position:absolute;top:8px;left:8px;z-index:10000;">
